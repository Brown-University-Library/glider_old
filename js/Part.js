...
/*
  ...
  MessageBroker interface should be attached to the instance -- so it has access to id's etc.
        ...
        let handler = {
          ...
          set: (pStore, prop, value) => {
            ...
            if (typeof(value) === 'function') {
              ...
              if (functionHandlerVersion === 1) {
                ...
                functionHandler = {
                  apply: function(target, thisArg, argumentsList) {
                    Part.messageBroker.remoteCall(partMethodName, argumentsList);
              ...
              Part.messageBroker.send('Update ' + prop + ' to value ' + value);
              pStore[prop] = value;
            }
